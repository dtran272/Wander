...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private val REQUEST_LOACTION_PERMISSION = 1
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val home = LatLng(45.38892553985043, -73.59654164395026)
        val zoomLevel = 15f
    ...
    /**
     * Drops pins on map during long click.
     */
    ...
    /**
     * Show info of Point of interest in snippet when clicked.
     */
    ...
    private fun setGroundOverlay(pos: LatLng, map: GoogleMap) {
